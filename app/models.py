...
class Domains(models.Model):
    uid = models.AutoField(primary_key=True)
    url = models.CharField(max_length=50, unique=True, verbose_name='域名')
...
class Other_Url(models.Model):
    uid = models.AutoField(primary_key=True)
    url = models.CharField(max_length=200,unique=True,verbose_name='爬行网址')
...
class Error_Log(models.Model):
    uid = models.AutoField(primary_key=True)
    url = models.CharField(max_length=200,verbose_name='异常网址')
